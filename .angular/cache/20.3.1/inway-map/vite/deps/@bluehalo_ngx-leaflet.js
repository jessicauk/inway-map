...
var _LeafletUtil = class _LeafletUtil {
...
__name(_LeafletUtil, "LeafletUtil");
var LeafletUtil = _LeafletUtil;
var _LeafletDirective = class _LeafletDirective {
  ...
  addMapEventListeners() {
    const registerEventHandler = /* @__PURE__ */ __name((eventName, handler) => {
    ...
    const outputUpdateHandler = /* @__PURE__ */ __name(() => {
...
__name(_LeafletDirective, "LeafletDirective");
_LeafletDirective.ɵfac = /* @__PURE__ */ __name(function LeafletDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LeafletDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
}, "LeafletDirective_Factory");
_LeafletDirective.ɵdir = ɵɵdefineDirective({
  type: _LeafletDirective,
  selectors: [["", "leaflet", ""]],
  hostBindings: /* @__PURE__ */ __name(function LeafletDirective_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("resize", /* @__PURE__ */ __name(function LeafletDirective_resize_HostBindingHandler() {
        return ctx.onResize();
      }, "LeafletDirective_resize_HostBindingHandler"), ɵɵresolveWindow);
    }
  }, "LeafletDirective_HostBindings"),
  inputs: {
...
var _LeafletDirectiveWrapper = class _LeafletDirectiveWrapper {
...
__name(_LeafletDirectiveWrapper, "LeafletDirectiveWrapper");
var LeafletDirectiveWrapper = _LeafletDirectiveWrapper;
...
__name(_LeafletLayerDirective, "LeafletLayerDirective");
_LeafletLayerDirective.ɵfac = /* @__PURE__ */ __name(function LeafletLayerDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LeafletLayerDirective)(ɵɵdirectiveInject(LeafletDirective), ɵɵdirectiveInject(NgZone));
}, "LeafletLayerDirective_Factory");
...
__name(_LeafletLayersDirective, "LeafletLayersDirective");
_LeafletLayersDirective.ɵfac = /* @__PURE__ */ __name(function LeafletLayersDirective_Factory(__ngFactoryType__) {
...
}, "LeafletLayersDirective_Factory");
...
var _LeafletControlLayersChanges = class _LeafletControlLayersChanges {
  constructor() {
...
__name(_LeafletControlLayersChanges, "LeafletControlLayersChanges");
var LeafletControlLayersChanges = _LeafletControlLayersChanges;
var _LeafletControlLayersWrapper = class _LeafletControlLayersWrapper {
...
__name(_LeafletControlLayersWrapper, "LeafletControlLayersWrapper");
var LeafletControlLayersWrapper = _LeafletControlLayersWrapper;
var _LeafletControlLayersConfig = class _LeafletControlLayersConfig {
  constructor() {
    this.baseLayers = {};
    this.overlays = {};
  }
};
__name(_LeafletControlLayersConfig, "LeafletControlLayersConfig");
var LeafletControlLayersConfig = _LeafletControlLayersConfig;
...
__name(_LeafletLayersControlDirective, "LeafletLayersControlDirective");
_LeafletLayersControlDirective.ɵfac = /* @__PURE__ */ __name(function LeafletLayersControlDirective_Factory(__ngFactoryType__) {
...
}, "LeafletLayersControlDirective_Factory");
...
__name(_LeafletBaseLayersDirective, "LeafletBaseLayersDirective");
_LeafletBaseLayersDirective.ɵfac = /* @__PURE__ */ __name(function LeafletBaseLayersDirective_Factory(__ngFactoryType__) {
...
}, "LeafletBaseLayersDirective_Factory");
...
__name(_LeafletModule, "LeafletModule");
_LeafletModule.ɵfac = /* @__PURE__ */ __name(function LeafletModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LeafletModule)();
}, "LeafletModule_Factory");
...
var _LeafletTileLayerDefinition = class _LeafletTileLayerDefinition {
...
__name(_LeafletTileLayerDefinition, "LeafletTileLayerDefinition");
var LeafletTileLayerDefinition = _LeafletTileLayerDefinition;
export {
